CREATE OR REPLACE VIEW student.v_parcels_join AS
SELECT
...
ON defaultdb.enterprise.parcels_core.pin = 
   defaultdb.enterprise.parcel_sales.pin
WHERE
	defaultdb.enterprise.parcel_sales.sale_value > 300000 OR defaultdb.enterprise.parcel_sales.sale_value < 100000;
